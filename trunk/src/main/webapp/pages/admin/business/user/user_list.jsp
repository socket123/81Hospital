...
<script type="text/javascript" src="${url }statics/admin/js/business/userlist.js"></script>
...
<div id="contentwrapper" class="contentwrapper">
    ...
    <div class="dataTables_wrapper" id="dyntable2_wrapper">
        ...
        <div class="dataTables_filter" id="dyntable2_filter">
            <label>姓名: <input type="text" name="userName" value="${user.userName }">&nbsp;&nbsp;</label>
            <label>手机号: <input type="text" name="phone" value="${user.phone }">&nbsp;&nbsp;</label>
