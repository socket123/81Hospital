...
<div id="contentwrapper" class="contentwrapper">
	...
	<div class="dataTables_wrapper" id="dyntable2_wrapper">
		...
		<a class="btn btn_orange btn_search radius50" onclick="excels('order','listHistory')"><span>导出</span></a>
		<a class="btn btn_orange btn_search radius50" onclick="searchFormListDepartment('order','listHistory')"><span>搜索</span></a>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable" id="dyntable2">
			...
			<tbody>
				<c:forEach items="${page.list }" var="list" varStatus="vars">
				<tr class="gradeX">
					<td>${vars.index }</td>
					<td>
...
$('#page-jq').jqPaginator({
    ...
    onPageChange:function(num,type){
    	if(type == 'change'){
            ListDepartment('order','currentIndex='+num+'&'+$('#searchForm').serialize(),"listHistory");
    	}
    }
});
