...
<div id="contentwrapper" class="contentwrapper">
	...
	<div class="dataTables_wrapper" id="dyntable2_wrapper">
		...
		<a class="btn btn_orange btn_search radius50" onclick="excels('order','list_history')"><span>导出</span></a>
		<a class="btn btn_orange btn_search radius50" onclick="searchFormListDepartment('order','list_history')"><span>搜索</span></a>
...
$('#page-jq').jqPaginator({
    ...
    onPageChange:function(num,type){
    	if(type == 'change'){
            ListDepartment('order','currentIndex='+num+'&'+$('#searchForm').serialize(),'list_history');
    	}
    }
});
