...
<div id="contentwrapper" class="contentwrapper">
	...
	<div class="dataTables_wrapper" id="dyntable2_wrapper">
		...
		<a class="btn btn_orange btn_search radius50" onclick="excels('order','ListDepartment')"><span>导出</span></a>
		...
		<%--</div>--%>
				...
				<div class="dataTables_filter" id="dyntable2_filter" style="width: 30%;">
					...
					<label>科室:
						<select name="id" id="id" onchange="gradeChange('order','ListDepartment')" style="margin: -7px 0 0 0;">
